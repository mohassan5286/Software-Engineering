      ...
      {information && (
        <div className="destination-page-information">
          ...
          <div className="destination-page-content">
            ...
            <p><strong>Rating:</strong> {information.rating}   <img width="17" height="17" src="https://img.icons8.com/external-flaticons-flat-flat-icons/64/external-star-web-flaticons-flat-flat-icons-3.png" alt="external-star-web-flaticons-flat-flat-icons-3"/></p>
