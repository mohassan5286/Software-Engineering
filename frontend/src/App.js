  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route
          path="/home"
          element={<Home setPid={setPid} setInformation={setInformation} />}
        />
        ...
        />
        <Route path="/login" element={<Login setUserId={handleLogin} />} />
        <Route path="/" element={<Login setUserId={handleLogin} />} />
        <Route path="/wishlist" element={<Wishlist setUserId={setUserId} />} />
        <Route
          path="/destination-page/:pid"
          element={
